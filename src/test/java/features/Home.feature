...
@SmokeTest
Scenario: As a user I will check whether logo is displayed or not
...
Scenario: As a user In home I will select Best Seller and I will get All the Dress text
